module pyth_navi::set_update_fee {
    use sui::math::{Self};
    ...
    public(friend) fun execute(latest_only: &LatestOnly, pyth_navi_state: &mut State, payload: vector<u8>) {
        ...
        state::set_base_update_fee(latest_only, pyth_navi_state, fee);
    }
...
#[test_only]
module pyth_navi::set_update_fee_tests {
    ...
    fun test_set_update_fee(){
        ...
        assert!(state::get_base_update_fee(&pyth_navi_state)==500000, 0);
