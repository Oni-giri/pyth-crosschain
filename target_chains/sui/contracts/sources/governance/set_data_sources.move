module pyth_navi::set_data_sources {
    use std::vector;
...
#[test_only]
module pyth_navi::set_data_sources_tests {
    ...
    use pyth_navi::data_source::Self;
    ...
    fun set_data_sources(){
        ...
        assert!(state::is_valid_data_source(&pyth_navi_state, data_source::new(1, external_address::new(bytes32::from_bytes(x"f346195ac02f37d60d4db8ffa6ef74cb1be3550047543a4a9ee9acf4d78697b0")))), 0);
        assert!(state::is_valid_data_source(&pyth_navi_state, data_source::new(26, external_address::new(bytes32::from_bytes(x"a27839d641b07743c0cb5f68c51f8cd31d2c0762bec00dc6fcd25433ef1ab5b6")))), 0);
        assert!(state::is_valid_data_source(&pyth_navi_state, data_source::new(26, external_address::new(bytes32::from_bytes(x"e101faedac5851e32b9b23b5f9411a8c2bac4aae3ed4dd7b811dd1a72ea4aa71")))), 0);
